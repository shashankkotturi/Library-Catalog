...
var HairlineDivider = function HairlineDivider(_ref) {
  ...
  return React__default.createElement('hr', _extends({}, safeRest(rest), { className: styles[getClassName(vertical, gradient)] }));
};
...
var Box = function Box(_ref) {
  ...
  return React__default.createElement(tag, _extends({}, safeRest(rest), { className: classes }), children);
};
...
var Icon = function Icon(_ref) {
  ...
  return React__default.createElement('i', _extends({}, safeRest(rest), { className: classes }));
};
...
var DecorativeIcon = function DecorativeIcon(_ref) {
  var symbol = _ref.symbol,
      ...
      size = _ref.size,
      rest = objectWithoutProperties(_ref, ['symbol', 'variant', 'size']);
  return React__default.createElement(Icon, _extends({}, rest, { symbol: symbol, variant: variant, size: size, 'aria-hidden': 'true' }));
};
...
var Text = function Text(_ref, context) {
  ...
  return React__default.createElement(block ? 'div' : 'span', _extends({}, safeRest(rest), {
    className: classes
  }), children);
};
...
var DimpleDivider = function DimpleDivider(_ref) {
  ...
  return React__default.createElement('hr', _extends({}, safeRest(rest), { className: styles$5.dimple }));
};
        ...
        React__default.createElement(
          ...
          function () {
            return React__default.createElement(
              Text,
              { size: 'large' },
              React__default.createElement(DecorativeIcon, { symbol: open ? 'caretUp' : 'caretDown', variant: 'primary', size: 16 })
            );
          }
        )
      );
    ...
    _this.renderHeader = function (header, subtext, tertiaryText) {
      return React__default.createElement(
        ...
        React__default.createElement(
          ...
          subtext && React__default.createElement(
            Text,
            { size: 'small' },
            subtext
          )
        ),
        tertiaryText && React__default.createElement(
          'span',
  ...
  createClass(PanelWrapper, [{
    ...
    value: function render() {
      ...
      return React__default.createElement(
        ...
        React__default.createElement(
          ...
          function () {
            return React__default.createElement(
              ...
              React__default.createElement(DimpleDivider, null),
              React__default.createElement(
                Box,
                { inset: 4 },
                React__default.createElement(
        ...
        React__default.createElement(HairlineDivider, null)
      );
    }
  }]);
  return PanelWrapper;
...
var Panels = function Panels(_ref) {
  ...
  return React__default.createElement(
    ...
    topDivider && React__default.createElement(HairlineDivider, null),
    React__default.Children.toArray(children).filter(Boolean).map(function (panel) {
...
var BaseButton = function BaseButton(_ref) {
  ...
  return React__default.createElement(element, _extends({}, safeRest(rest), {
        ...
        React__default.createElement(
          ...
          React__default.createElement(
            ...
            React__default.createElement(
              ...
              React__default.createElement('input', _extends({}, safeRest(rest), {
                id: choiceId,
                type: type,
                name: name,
                value: value,
...
var Checkbox = function Checkbox(props) {
  return React__default.createElement(
    ...
    function (checked) {
      return checked && React__default.createElement(DecorativeIcon, { symbol: 'checkmark', size: 16, variant: 'inverted' });
    }
  );
};
...
var getIcon = function getIcon(symbol, classes) {
  return React__default.createElement(
    'span',
    { className: classes },
    React__default.createElement(DecorativeIcon, { symbol: symbol, size: 16 })
  );
};
...
var ChevronLink = function ChevronLink(_ref) {
  ...
  var innerLink = React__default.createElement(
    Box,
  ...
  return React__default.createElement(reactRouterLinkComponent || 'a', _extends({}, safeRest(rest), {
...
var BaseHeading = function BaseHeading(_ref) {
  ...
  return React__default.createElement(level, _extends({}, safeRest(rest), {
...
var Image = function Image(_ref) {
  ...
  return React__default.createElement('img', _extends({}, safeRest(rest), {
    src: src,
    width: width,
    height: height,
    alt: alt,
...
var StandaloneIcon = function StandaloneIcon(_ref) {
  ...
  return React__default.createElement(Icon, _extends({}, safeRest(rest), iconProps));
};
  ...
  createClass(Tooltip, [{
    ...
    value: function render() {
      ...
      return React__default.createElement(
        ...
        React__default.createElement(StandaloneIcon, {
        ...
        React__default.createElement(Responsive, {
          defaultMatches: true,
          maxWidth: 'sm',
    ...
    value: function render() {
      ...
      return React__default.createElement(
        ...
        React__default.createElement(
          ...
          tooltip && React__default.cloneElement(tooltip, { connectedFieldLabel: label })
        ),
...
var renderIcon = function renderIcon(feedback) {
  if (feedback === 'success') {
    return React__default.createElement(StandaloneIcon, {
      symbol: 'checkmark',
      variant: 'primary',
      size: 16,
  ...
  return React__default.createElement(
    ...
    function (_ref, showFeedbackIcon, feedback) {
      ...
      return React__default.createElement(
        ...
        !inputProps.disabled && React__default.createElement(
          'div',
          { className: styles$25.iconsPosition },
          React__default.createElement(FeedbackIcon, { showIcon: showFeedbackIcon, feedback: feedback })
        )
      );
    }
  );
...
var renderIcon$1 = function renderIcon(icon) {
  return React__default.createElement(DecorativeIcon, { symbol: icon.symbol, variant: icon.color });
};
...
var Radio = function Radio(props) {
  return React__default.createElement(
    ...
    function (checked, disabled) {
      return checked && React__default.createElement('span', {
  ...
  return React__default.createElement(
    ...
    function (_ref2, showFeedbackIcon, feedback) {
      ...
      return React__default.createElement(
        ...
        !selectProps.disabled && React__default.createElement(
          Box,
...
function counterButton(props) {
  ...
  return React__default.createElement(
    ...
    React__default.createElement('i', { className: 'selector-counter__icon icon icon-core-' + icon })
  );
}
  ...
  createClass(SelectorCounter, [{
    ...
    value: function render() {
      ...
      var cssClasses = {
        ...
        React__default.createElement(counterButton, {
  ...
  function Spinner() {
    ...
    return _ret = (_temp = (_this = possibleConstructorReturn(this, (_ref = Spinner.__proto__ || Object.getPrototypeOf(Spinner)).call.apply(_ref, [this].concat(args))), _this), _this.getSpinWrapper = function (spinEl, spinning, wrapperClassNames) {
      ...
      return React__default.createElement(
        ...
        spinning && React__default.createElement('div', { className: 'spinner-wrapper__content-blocker' }),
        spinEl,
        React__default.createElement(
          'div',
      ...
      return React__default.createElement(
        'div',
        { className: cls },
        fullScreen && React__default.createElement('div', { className: 'spinner__full-screen-layer' }),
        React__default.createElement(
          'svg',
...
var Step = function Step(_ref) {
  ...
  return React__default.createElement(
    ...
    React__default.createElement('span', { className: 'step-tracker__icon' }),
    React__default.createElement(
      'span',
    ...
    value: function render() {
      ...
      return React__default.createElement(
        ...
        React__default.createElement(
          'ul',
          { className: cls },
          React__default.Children.map(children, function (element, index) {
  ...
  return React__default.createElement(
    ...
    function (_ref, showFeedbackIcon, feedback) {
      ...
      return React__default.createElement(
        ...
        React__default.createElement('textarea', _extends({}, textareaProps, {
          className: joinClassNames(className, styles$31.preventWidthResizing),
          style: addRightPadding(showFeedbackIcon ? 1 : 0)
        })),
        !textareaProps.disabled && React__default.createElement(
          'div',
...
var injectListStyle = function injectListStyle(child, listStyle) {
  return React__default.cloneElement(child, { listStyle: listStyle });
};
  ...
  return React__default.createElement(
    ...
    React__default.createElement(
      ...
      React__default.createElement(
        ...
        React__default.createElement('stop', { offset: '1', stopColor: '#d8d8d8' })
      ),
      React__default.createElement(
        'linearGradient',
        {
        ...
        React__default.createElement('stop', { offset: '0.19', stopColor: '#fff' }),
        React__default.createElement('stop', { offset: '1', stopColor: '#d8d8d8' })
      ),
      ...
      React__default.createElement(
        ...
        React__default.createElement(
          ...
          React__default.createElement(
            ...
            React__default.createElement('path', { d: 'M1200 146c-57.54-18-153.12-46.11-247.79-66.1-194.87 11.06-397.57 67-590.52 67-20.69 0-43.55-.74-67.8-2.06-46 8-91.66 13.16-136.77 13.16-42.2 0-100.58-6.26-157.12-14.1V224H1200Z' })
          )
        ),
        React__default.createElement('path', {
        ...
        React__default.createElement(
          ...
          React__default.createElement(
            'g',
            { className: styles$34.opacity2 },
            React__default.createElement('path', { d: 'M293.89 144.8C202.25 139.8 90.58 126.67 0 114.45V143.9C56.54 151.74 114.92 158 157.12 158 202.23 158 247.91 152.8 293.89 144.8Z' })
          )
        ),
        React__default.createElement('path', {
        ...
        React__default.createElement(
          ...
          React__default.createElement(
            'g',
            { className: styles$34.opacity2 },
            React__default.createElement('path', { d: 'M952.21 79.89c94.67 20 190.24 48.11 247.79 66.1V103.05C1134.77 89.47 1065.13 78 1016 78 994.85 78 973.58 78.68 952.21 79.89Z' })
          )
        ),
        React__default.createElement('path', {
        ...
        React__default.createElement('rect', { className: styles$34.gradient7, width: '180', height: '226' }),
        React__default.createElement('rect', { className: styles$34.gradient8, x: '1020', width: '180', height: '226' }),
        React__default.createElement('rect', { className: styles$34.gradient9, y: '154', width: '1202', height: '72' })
      )
    ),
    React__default.createElement(
      'g',
      null,
      React__default.createElement('rect', { className: styles$34.gradient10, y: '158.3', width: '1201.56', height: '67.5' }),
...
exports.SelectorCounter = SelectorCounter;
exports.Small = Small;
exports.Spinner = Spinner;
exports.StandaloneIcon = StandaloneIcon;
exports.Steps = Steps;
...
//# sourceMappingURL=tds.cjs.js.map
